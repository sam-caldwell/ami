...
- E_CALL_RESULT_MISMATCH: message sample = "return type mismatch from call"; data keys = actual, expected, expectedPos, index
...
- E_GENERIC_ARITY_MISMATCH: message sample = "generic type argument count mismatch"; data keys = actual, actualArity, base, expected, expectedArity, expectedPos, fieldPath, index, path, pathIdx
...
- E_RETURN_TYPE_MISMATCH: message sample = "inconsistent inferred return types"; data keys = actual, expected, expectedPos, index
