...
// addExternsForExpr inspects an expression and records any required runtime externs.
func addExternsForExpr(e *ModuleEmitter, ex ir.Expr) {
    ...
    // Math externs (aggregate + scalar helpers)
    ...
    case "ami_rt_math_nan":
        e.RequireExtern("declare double @ami_rt_math_nan()")
    case "ami_rt_math_remainder":
