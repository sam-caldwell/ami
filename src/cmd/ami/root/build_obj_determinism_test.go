...
`
	...
	if err != nil {
		t.Fatalf("read asm1: %v", err)
	}
	var idx1 sch.ObjIndexV1
	if err := json.Unmarshal(idx1b, &idx1); err != nil {
		t.Fatalf("unmarshal idx1: %v", err)
	}
	// normalize timestamp
	idx1.Timestamp = ""
	...
	if err != nil {
		t.Fatalf("read asm2: %v", err)
	}
	var idx2 sch.ObjIndexV1
	if err := json.Unmarshal(idx2b, &idx2); err != nil {
		t.Fatalf("unmarshal idx2: %v", err)
	}
	idx2.Timestamp = ""
