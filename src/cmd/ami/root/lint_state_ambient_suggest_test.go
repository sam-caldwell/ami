...
// Ensure lint rejects legacy worker signature with explicit State parameter.
func TestLint_JSON_StateParam_Rejected(t *testing.T) {
...
`
    ...
    // Non-pointer State parameter (legacy form) should be rejected by worker signature validation
