...
func TestHelper_AmiLintJSON(t *testing.T) {
    if os.Getenv("GO_WANT_HELPER_AMI_LINT_JSON") != "1" && os.Getenv("GO_WANT_HELPER_AMI_JSON") != "1" { return }
...
func TestHelper_AmiLintJSONWithRules(t *testing.T) {
    if os.Getenv("GO_WANT_HELPER_AMI_LINT_WITH_RULES") != "1" { return }
...
func TestHelper_AmiLintHuman(t *testing.T) {
    if os.Getenv("GO_WANT_HELPER_AMI_LINT_HUMAN") != "1" { return }
